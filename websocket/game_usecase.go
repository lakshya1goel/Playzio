...
func (g *gameUsecase) startTurn(userID uint) {
	...
	g.Pool.BroadcastToRoom(g.GameRoomState.RoomID, model.NewNextTurnMessage(g.GameRoomState.RoomID, userID, newCharSet, g.GameRoomState.TimeLimit, g.GameRoomState.Round))
